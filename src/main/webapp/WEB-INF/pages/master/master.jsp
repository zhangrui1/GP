                    ...
                    <form action="/master/add" id="MasterForm" name="MasterForm" method="post">
                        ...
                        <%--</tr>--%>
                            <div class="master-row" >
                                <div class="col-md-3" >
                                    <input type="text" id="placename" name="placename" class="form-control sousa" placeholder="工事先" >
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <div class="tab-pane active" id="tab_1">
                                        <table class="table table-hover valve-table">
                                            ...
                                            <tr>
                                                ...
                                                <th><a class="SortPNU" name="SortPNU" href="/master/sort/placenameUnit">工事先ユニーク</a></th>
                                                <th><a class="SortPNS" name="SortPNS" href="/master/sort/ryakuplaceshortname">工事先略称</a></th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="operation-button">
                                                                <a class="btn btn-primary btn-sm operation-button-btn" href="/master/edit/${masterLists.id}"><i class="fa fa-pencil"></i></a>
                                                                <a class="btn btn-danger btn-sm operation-button-btn" href="/master/delete/${masterLists.id}"><i class="fa fa-trash-o"></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                            </c:forEach>
